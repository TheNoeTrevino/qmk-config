...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        // TO(5),        KC_1,         KC_2,           KC_3,           KC_4,     KC_5,                               KC_6,          KC_7,        KC_8,           KC_9,            KC_0,     LT(4, KC_DEL),
              KC_PSCR,        KC_1,         KC_2,           KC_3,           KC_4,     KC_5,                               KC_6,          KC_7,        KC_8,            KC_9,            KC_0,            LT(4, KC_DEL),
               KC_TAB,        KC_Q,         KC_W,           KC_E,           KC_R,     KC_T,                               KC_Y,          KC_U,        KC_I,            KC_O,            KC_P,                  KC_BSLS,
               KC_ESC,        KC_A,   LT(3, KC_S),    LT(2, KC_D),    LT(1, KC_F),    KC_G,                               KC_H,          KC_J,        KC_K,            KC_L,            KC_SCLN,               KC_QUOT,
              KC_LSFT,  GUI_T(KC_Z), LSFT_T(KC_X),    ALT_T(KC_C),    CTL_T(KC_V),    KC_B,                               KC_N,    CTL_T(KC_M), ALT_T(KC_COMM), LSFT_T(KC_DOT),         GUI_T(KC_SLSH),        KC_RSFT,
                                                                         CW_TOGG,  MO(4), KC_BSPC,                   KC_SPC,  KC_ENT,  KC_RSFT
        // TODO: implement function layer
    ),
    // keypad
    [1] = LAYOUT(
    ...
    [3] = LAYOUT(
        KC_GRV,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                              KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
        KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                            KC_PPLS, KC_AMPR, KC_ASTR, KC_UNDS, KC_TRNS, KC_TRNS,
    ...
    [4] = LAYOUT(
        ...
        KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS,        KC_TRNS,                                  KC_TRNS, KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS,        KC_TRNS,                                  KC_TRNS, MS_LEFT,    MS_DOWN, MS_UP,   MS_RGHT, KC_TRNS,
        KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS,        KC_TRNS,                                  KC_TRNS, KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                                                 KC_TRNS,        KC_TRNS, KC_TRNS,               MS_BTN1,  MS_BTN2, KC_PDOT
    ),
    // function keys
    [5] = LAYOUT(
        KC_TRNS,  KC_F1,   KC_F2,    KC_F3,     KC_F4,          KC_F5,                                    KC_F6,   KC_F7,      KC_F8,   KC_F9,   KC_F10,  KC_F11,
        KC_TRNS,  KC_F6,   KC_F7,    KC_F8,     KC_F9,          KC_F10,                                   KC_TRNS, KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS,  KC_F11,  KC_F12,   KC_F13,    KC_F14,         KC_F15,                                   KC_TRNS, MS_LEFT,    MS_DOWN, MS_UP,   MS_RGHT, KC_TRNS,
        KC_TRNS,  KC_TRNS, KC_TRNS,  KC_TRNS,   KC_TRNS,        KC_VOLD,                                  KC_TRNS, KC_KB_MUTE, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
